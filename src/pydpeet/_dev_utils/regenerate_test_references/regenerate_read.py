...
from pydpeet import read  # noqa: E402
...
df = read(config="basytec_6_3_1_0", input_path=input_txt, keep_all_additional_data=False)
df.to_parquet(_RES_DIR / "basytec_6_3_1_0-TC23LFP09_CU_25deg-converted.parquet")
print("Regenerated: read base data (without additional data)")

df_with_additional = read(config="basytec_6_3_1_0", input_path=input_txt, keep_all_additional_data=True)
df_with_additional.to_parquet(_RES_DIR / "basytec_6_3_1_0-TC23LFP09_CU_25deg-converted-with-additional.parquet")
print("Regenerated: read base data (with additional data)")
